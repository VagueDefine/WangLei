...
![](0000assets/14、电源设计%20-%20LDO%20电源抑制比（PSRR）与测量方法/file-20260530153811172.png)
电源抑制比（PSRR）用公式表示为：
$$
...
![](0000assets/14、电源设计%20-%20LDO%20电源抑制比（PSRR）与测量方法/file-20260530153811173.png)
可以看出，在频率为 $1kHz$ 时，`XC6206P302` 的纹波抑制比约为 $23dB$。
再看高速 $LDO$（`XC6217x302`）的纹波抑制曲线：
![](0000assets/14、电源设计%20-%20LDO%20电源抑制比（PSRR）与测量方法/file-20260530153811172%201.png)
在频率为 $1kHz$ 时，`XC6217x302` 的纹波抑制比约为 $68dB$。
## 电源抑制比（PSRR）的测量方法
![](0000assets/14、电源设计%20-%20LDO%20电源抑制比（PSRR）与测量方法/file-20260530153811175.png)
...
可按照以下的示意图设计加法器：
![](0000assets/14、电源设计%20-%20LDO%20电源抑制比（PSRR）与测量方法/file-20260530153811174.png)
其中，$R1$ 与 $R2$ 相等，最低截止频率由 $C1$ 和 $R1$ 共同决定，最高截止频率由运放的带宽所决定。
![](0000assets/14、电源设计%20-%20LDO%20电源抑制比（PSRR）与测量方法/file-20260530153811176%201.png)
#### 信号发生器 + 运算放大器
使用运放作为信号发生器的电压跟随器，可解除信号发生器驱动电流不足的限制。
#### LC 节点法
利用电感和电容实现 DC 电压和 AC 电压的叠加，一起作为 LDO 的输入：
![](0000assets/14、电源设计%20-%20LDO%20电源抑制比（PSRR）与测量方法/file-20260530153811176.png)
...
![](0000assets/14、电源设计%20-%20LDO%20电源抑制比（PSRR）与测量方法/file-20260530153811177.png)
...
![](0000assets/14、电源设计%20-%20LDO%20电源抑制比（PSRR）与测量方法/file-20260530153811177%201.png)
![](0000assets/14、电源设计%20-%20LDO%20电源抑制比（PSRR）与测量方法/file-20260530153811178.png)
### 输出测量
#### 示波器
...
放大电路的设计：
![](0000assets/14、电源设计%20-%20LDO%20电源抑制比（PSRR）与测量方法/file-20260530153811178%201.png)
该电路的最低截止频率由 $C1$ 和 $R1$ 所决定，最高截止频率由运放的带宽所决定。
#### 频谱分析仪 / 网分仪
频谱分析仪可以测量微伏级电压信号，可以配合使用高阻抗输入探头来测量 LDO 输出交流电压。如果没有高阻抗探头，可以用运放搭建：
![](0000assets/14、电源设计%20-%20LDO%20电源抑制比（PSRR）与测量方法/file-20260530153811179.png)
## 测量注意事项
...
![](0000assets/14、电源设计%20-%20LDO%20电源抑制比（PSRR）与测量方法/file-20260530153811180.png)
## 参考
